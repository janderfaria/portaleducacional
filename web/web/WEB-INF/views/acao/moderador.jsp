                ...
                <div class="col-md-10 col-sm-offset-1">    
                    <div class="panel panel-default">
                        <div class="panel-body" style="font-size: large; text-align: justify;">
                            <img src="<c:url value="/resources/img/moderador.png"/>" width="300" align="left">
                            <p> Espaço reservado para divulgação de informações relacionadas à gestão técnica, ou seja, alterações, melhorias e manutenções no portal,  e gestão de conteúdo, como erratas sobre questões, respostas, avaliações, resultado de alguma premiação, etc.</p>
                        </div>
                    </div>
                </div>
            </div>
