                ...
                <div class="col-md-10 col-sm-offset-1">    
                    <div class="panel panel-default">
                        <div class="panel-body" style="font-size: large; line-height: 28px; padding-bottom: 20px; text-align: justify;">
                            ...
                            <p> Nas estatísticas serão apresentados índices relacionados diretamente às informações do portal como questões mais acessadas, questões melhores avaliadas tanto pelos usuários como pelo moderador, número de questões recebidas e utilizadas, número de usuários cadastrados, estados participantes, etc.</p>
                            <p>Outras estatísticas externas ao site também serão divulgadas como índices relacionados à educação e aqueles relacionados ao impacto para os usuários do portal e nas escolas, através de pesquisas ou informações enviadas pelos próprios usuários.</p>
                        </div>
            </div>
        </div>
